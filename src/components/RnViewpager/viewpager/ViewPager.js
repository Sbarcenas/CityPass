...
export default class ViewPager extends Component {
    ...
    _renderOnIOS () {
        ...
        if (this.props.style && !this.props.style.height)
            return <ScrollView showsHorizontalScrollIndicator={false} {...props} style={[scrollViewStyle, this.props.style]} />
        else return (
            <View style={this.props.style} >
                <ScrollView showsHorizontalScrollIndicator={false} {...props} style={scrollViewStyle} />
            </View>
        )
    }
